...
const TOOL_FAQ: Record<string, { q: string; a: string }[]> = {
  ...
  'video-parser-downloader': [
    { q: '可以保证去除视频水印吗？', a: '不保证。若视频画面本身已有平台或作者水印，本站不会承诺或专门去除，只按平台实际返回的公开视频源处理。' },
    { q: '支持合集、多 P 或会员视频吗？', a: '不支持。目前只处理无需登录即可访问的单个公开视频，不支持合集、多 P、会员、付费、私密或直播内容。' },
    { q: '解析链接会发送到哪里？', a: '链接会发送到本站视频后端，由后端访问对应平台并临时处理；解析凭证、任务和完成文件都会自动过期。' },
  ],
};
