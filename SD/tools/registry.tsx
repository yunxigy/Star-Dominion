...
export interface ToolDef {
  ...
  /** 测评呈现类型：问卷或互动挑战 */
  assessmentKind?: 'questionnaire' | 'challenge';
  /** 测评题量 */
...
const BrainPowerTest = React.lazy(() => import('../components/tools/test/BrainPowerTest'));
const IntelligenceTest = React.lazy(() => import('../components/tools/test/IntelligenceTest'));
const BrainGym = React.lazy(() => import('../components/tools/test/BrainGym'));
...
const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  // 测评中心
  { id: 'mbti-test', name: 'MBTI 40 题扩展版', description: '从四个偏好维度了解你的性格倾向', icon: 'Brain', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: MbtiTest, assessmentGroup: 'personality', questionCount: 40, quickQuestionCount: 16, estimatedMinutes: 8, quickEstimatedMinutes: 4, sensitive: false, tags: ['mbti', '人格', '性格', '40题', '四维偏好'] },
  { id: 'big-five-test', name: '大五人格测试', description: '从五个维度观察开放、尽责、外向、宜人和情绪敏感度', icon: 'Brain', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: BigFiveTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 25, quickQuestionCount: 10, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['大五人格', '人格', '性格', 'big five'] },
  { id: 'enneagram-test', name: '九型人格探索', description: '从核心动机、压力反应与关系需要观察九种倾向', icon: 'Pentagon', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: EnneagramTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 27, quickQuestionCount: 9, estimatedMinutes: 8, quickEstimatedMinutes: 3, sensitive: false, tags: ['九型人格', '人格', '动机', 'enneagram'] },
  { id: 'attachment-style-test', name: '依恋互动风格', description: '观察亲密关系中的安全感、边界和回应需要', icon: 'HeartHandshake', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: AttachmentStyleTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 8, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['依恋', '关系', '安全感', 'attachment'] },
  { id: 'love-language-test', name: '爱的表达偏好', description: '发现你更容易接收和表达在乎的方式', icon: 'Heart', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: LoveLanguageTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 25, quickQuestionCount: 10, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['爱情语言', '关系沟通', '表达偏好', 'love language'] },
  { id: 'career-interest-test', name: '职业兴趣六型探索', description: '用 RIASEC 六种兴趣线索寻找更有能量的工作场景', icon: 'Users', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: CareerInterestTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['职业兴趣', '霍兰德', 'RIASEC', 'career'] },
  { id: 'disc-test', name: 'DISC 行为风格', description: '了解你在目标、互动、稳定与规则之间的行为偏好', icon: 'Briefcase', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: DiscTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 8, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['DISC', '职场性格', '行为风格', 'disc'] },
  { id: 'procrastination-test', name: '拖延模式探索', description: '找出启动、完美压力、分心和能量节奏中的卡点', icon: 'Timer', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: ProcrastinationTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 8, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['拖延', '效率', '行动', 'procrastination'] },
  { id: 'social-anxiety-test', name: '社交紧张度自测', description: '了解社交前后让你消耗的环节与可练习空间', icon: 'Eye', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: SocialAnxietyTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 8, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['社交紧张', '社交焦虑', '自我观察', 'social'] },
  { id: 'learning-style-test', name: '学习方式偏好', description: '发现你更容易理解和记住内容的学习路径', icon: 'BookOpen', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: LearningStyleTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 8, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['学习风格', '学习方式', '效率', 'learning'] },
  { id: 'emotional-stability-test', name: '情绪稳定性自测', description: '从冷静、调节、视角与恢复四个角度观察自己的状态', icon: 'Activity', category: 'test', color: 'violet', gradient: 'from-violet-600 to-purple-600', glow: 'rgba(139,92,246,0.3)', component: EmotionalStabilityTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 8, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['情绪稳定', '情绪调节', '自我观察', 'emotion'] },
  { id: 'animal-personality-test', name: '动物人格测试', description: '24 个生活场景，看看你更像哪种动物伙伴', icon: 'Brain', category: 'test', color: 'pink', gradient: 'from-orange-500 to-pink-500', glow: 'rgba(236,72,153,0.3)', component: AnimalPersonalityTest, privacy: 'local', status: 'stable', assessmentGroup: 'fun', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: false, tags: ['动物人格', '趣味测试', 'animal', '性格'] },
  { id: 'color-personality-test', name: '色彩人格测试', description: '24 个情境选择，发现你的代表色与行动气质', icon: 'Palette', category: 'test', color: 'pink', gradient: 'from-rose-500 to-orange-500', glow: 'rgba(244,114,182,0.3)', component: ColorPersonalityTest, privacy: 'local', status: 'stable', assessmentGroup: 'fun', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: false, tags: ['色彩人格', '颜色测试', '趣味', 'color'] },
  { id: 'life-energy-test', name: '生活能量类型', description: '探索你补充能量、投入行动和恢复节奏的方式', icon: 'Activity', category: 'test', color: 'pink', gradient: 'from-amber-500 to-rose-500', glow: 'rgba(251,146,60,0.3)', component: LifeEnergyTest, privacy: 'local', status: 'stable', assessmentGroup: 'fun', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: false, tags: ['生活能量', '恢复方式', '趣味', 'energy'] },
  { id: 'communication-style-test', name: '沟通风格测试', description: '了解你的直接、分析、共情与协作倾向', icon: 'MessageSquare', category: 'test', color: 'violet', gradient: 'from-violet-600 to-fuchsia-600', glow: 'rgba(139,92,246,0.3)', component: CommunicationStyleTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: false, tags: ['沟通风格', '表达', '协作', 'communication'] },
  { id: 'emotional-intelligence-test', name: '情绪智力测试', description: '观察自我觉察、调节、共情与关系管理', icon: 'Heart', category: 'test', color: 'violet', gradient: 'from-fuchsia-600 to-violet-600', glow: 'rgba(168,85,247,0.3)', component: EmotionalIntelligenceTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: false, tags: ['情绪智力', '情商', '共情', 'eq'] },
  { id: 'core-values-test', name: '核心价值观测试', description: '发现自主、稳定、成就、连接、探索与贡献偏好', icon: 'Brain', category: 'test', color: 'violet', gradient: 'from-indigo-600 to-violet-600', glow: 'rgba(99,102,241,0.3)', component: CoreValuesTest, privacy: 'local', status: 'stable', assessmentGroup: 'personality', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 7, quickEstimatedMinutes: 3, sensitive: false, tags: ['核心价值观', '人生选择', '价值排序', 'values'] },
  { id: 'orientation-spectrum-test', name: '吸引倾向光谱探索', description: '温和观察性吸引方向、低频体验与探索状态', icon: 'Eye', category: 'test', color: 'indigo', gradient: 'from-rose-500 to-indigo-600', glow: 'rgba(99,102,241,0.3)', component: OrientationSpectrumTest, privacy: 'local', status: 'stable', assessmentGroup: 'orientation', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: true, tags: ['吸引倾向', '性取向探索', '光谱', 'orientation'] },
  { id: 'romantic-orientation-test', name: '浪漫倾向探索', description: '分开观察浪漫心动、深度连接与低频体验', icon: 'Heart', category: 'test', color: 'indigo', gradient: 'from-pink-500 to-indigo-600', glow: 'rgba(99,102,241,0.3)', component: RomanticOrientationTest, privacy: 'local', status: 'stable', assessmentGroup: 'orientation', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: true, tags: ['浪漫倾向', '浪漫吸引', '关系探索', 'romantic'] },
  { id: 'intimacy-boundaries-test', name: '亲密边界风格', description: '了解自主、靠近、透明沟通与渐进节奏偏好', icon: 'ShieldCheck', category: 'test', color: 'indigo', gradient: 'from-teal-600 to-indigo-600', glow: 'rgba(79,70,229,0.3)', component: IntimacyBoundariesTest, privacy: 'local', status: 'stable', assessmentGroup: 'orientation', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 6, quickEstimatedMinutes: 3, sensitive: true, tags: ['亲密边界', '关系边界', '沟通', 'intimacy'] },
  { id: 'brain-power-test', name: '脑力挑战', description: '用记忆、注意、逻辑和灵活四组题目热身大脑', icon: 'Brain', category: 'test', color: 'pink', gradient: 'from-fuchsia-500 to-violet-600', glow: 'rgba(217,70,239,0.3)', component: BrainPowerTest, privacy: 'local', status: 'stable', assessmentGroup: 'fun', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 8, quickEstimatedMinutes: 4, sensitive: false, tags: ['脑力', '记忆', '注意力', '逻辑', 'brain'] },
  { id: 'intelligence-test', name: '综合智力挑战', description: '语言、数字、逻辑与空间四类题目的综合热身', icon: 'Brain', category: 'test', color: 'pink', gradient: 'from-violet-500 to-indigo-600', glow: 'rgba(99,102,241,0.3)', component: IntelligenceTest, privacy: 'local', status: 'stable', assessmentGroup: 'fun', questionCount: 24, quickQuestionCount: 12, estimatedMinutes: 8, quickEstimatedMinutes: 4, sensitive: false, tags: ['智力', '语言推理', '数字推理', '空间想象', 'intelligence'] },
  { id: 'brain-gym', name: '脑力挑战台', description: '反应速度、数字记忆和方格序列三种互动闯关', icon: 'Zap', category: 'test', color: 'pink', gradient: 'from-fuchsia-500 to-violet-600', glow: 'rgba(217,70,239,0.3)', component: BrainGym, privacy: 'local', status: 'stable', assessmentGroup: 'fun', assessmentKind: 'challenge', sensitive: false, tags: ['脑力小游戏', '反应速度', '数字记忆', '方格记忆', 'brain gym'] },
  ...
  { id: 'markup-converter', name: 'Markdown/HTML 互转', description: 'Markdown、HTML 与纯文本互转', icon: 'FileCode2', category: 'text', color: 'cyan', gradient: 'from-sky-600 to-cyan-600', glow: 'rgba(14,165,233,0.3)', component: MarkupConverterTool, privacy: 'local', status: 'stable', tags: ['markdown', 'html', '纯文本', '转换', 'zhuanhuan'] },
