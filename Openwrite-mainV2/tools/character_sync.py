...
def parse_profile_to_card(md_file: Path) -> Optional[Dict[str, Any]]:
    try:
        ...
        # Older Windows projects may contain GBK/GB18030 Markdown files.
        # Keep the canonical writer path UTF-8 while accepting those legacy
        # character profiles during synchronization.
        content = md_file.read_text(encoding="gb18030")
