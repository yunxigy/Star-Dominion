...
class TestIntegration31Tools:
    ...
    24. edit_world_relation - 增量预览或确认关系修改
    25. get_outline_structure - 读取结构树并推荐下一章
    26. edit_outline_structure - 增量增删改结构树
    """

    def test_01_list_chapters(self):
        """1. list_chapters - 列出章节"""
        print("\n" + "─" * 60)
        print("工具1/25: list_chapters")
        print("─" * 60)
    ...
    def test_05_get_world_relations(self):
        ...
        print("\n" + "─" * 60)
        print("工具5/25: get_world_relations")
        print("─" * 60)
    ...
    def test_06_create_foreshadowing(self):
        ...
        print("\n" + "─" * 60)
        print("工具6/25: create_foreshadowing")
        print("─" * 60)
    ...
    def test_07_list_foreshadowing(self):
        ...
        print("\n" + "─" * 60)
        print("工具7/25: list_foreshadowing")
        print("─" * 60)
    ...
    def test_08_update_foreshadowing(self):
        ...
        print("\n" + "─" * 60)
        print("工具8/25: update_foreshadowing")
        print("─" * 60)
    ...
    def test_09_validate_foreshadowing(self):
        ...
        print("\n" + "─" * 60)
        print("工具9/25: validate_foreshadowing")
        print("─" * 60)
    ...
    def test_11_update_truth_file(self):
        ...
        print("\n" + "─" * 60)
        print("工具11/25: update_truth_file")
        print("─" * 60)
    ...
    def test_13_extract_dialogue_fingerprint(self):
        ...
        print("\n" + "─" * 60)
        print("工具13/25: extract_dialogue_fingerprint")
        print("─" * 60)
    ...
    def test_14_validate_post_write(self):
        ...
        print("\n" + "─" * 60)
        print("工具14/25: validate_post_write")
        print("─" * 60)
    ...
    def test_15_get_workflow_status(self):
        ...
        print("\n" + "─" * 60)
        print("工具15/25: get_workflow_status")
        print("─" * 60)
    ...
    def test_17_advance_workflow(self):
        ...
        print("\n" + "─" * 60)
        print("工具17/25: advance_workflow")
        print("─" * 60)
    ...
    def test_19_compress_section(self):
        ...
        print("\n" + "─" * 60)
        print("工具19/25: compress_section")
        print("─" * 60)
    ...
    def test_21_create_character(self):
        ...
        print("\n" + "─" * 60)
        print("工具21/25: create_character")
        print("─" * 60)
